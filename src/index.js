...
import {
  ...
  addProject,
  addTodo,
} from "./module/project-container-dom";
export { storeToLocal };
...
document
  .querySelector(".modal-btn-add-project")
...
document
  .querySelector("#close-project-edit-modal")
  .addEventListener("click", () => {
    document.querySelector("#modal-edit-project").close();
  });
document
  .querySelector(".modal-btn-edit-project")
  .addEventListener("click", () => {
    let index = document
...
function getFromLocal() {
  ...
  if (array) {
    array.forEach((project, projectIndex) => {
      projectContainer.addProjectToContainer(
        project.projectName,
        project.description
      );
      project.todoList.forEach((item) => {
        projectContainer.addTodoToProject(
          projectIndex,
          item.todoName,
          item.dateTime,
          item.note,
